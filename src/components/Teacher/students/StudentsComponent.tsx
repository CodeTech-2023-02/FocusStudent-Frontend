...
const StudentComponent: React.FC = () => {
    ...
    const [selectedCourse, setSelectedCourse] = React.useState<IStudentForm | undefined>();
        ...
        <div>
            <Box p={4}>
                ...
                <Grid item xs={12} sm={6} md={9}>
                    <TextField label="Buscar por apellido" fullWidth style={{ height: 50 }}/>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                <Button variant="outlined" style={{ height: 50 }} onClick={handleCreateCourse}>
                ...
                <Grid container spacing={3} pt={4}>
                    {students.map((course, index) => (
                        <Grid item xs={12} sm={6} md={4} key={index}>
                            <StudentCard course={course} onEdit={handleEditCourse} onDelete={handleDeleteCourse} />
                        </Grid>
                    ))}
                </Grid>
                <StudentFormDialog
