...
const passwordSchema = yup.object().shape({
    newPassword: yup.string().required("Required").min(6, "Debe tener al menos 6 caracteres"),
    confirmPassword: yup.string().oneOf([yup.ref('newPassword'), ''], 'Las contraseñas deben ser iguales').required('Required')
});
...
export const PasswordChangeDialog: React.FC<IPasswordChangeDialogProps> = ({ open, onClose, user }) => {
