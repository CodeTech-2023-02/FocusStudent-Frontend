...
export function useGetAllCoursesSection() {
  return useMutation<ICourseSectionTeacher[], Error, void>({
    mutationFn: () =>
    courseSectionRepository.getAllCourseSection().then((response) => response.body),
  });
}
...
export function useGetAllCoursesSectionByTeacher() {
  return useMutation<ICourseSectionTeacher[], Error, number>({
    ...
    courseSectionRepository.getAllCourseSectionByTeacher(teacherId).then((response) => response.body),
  });
}
...
export function useGetAllCoursesSectionBySection() {
  return useMutation<ICourseSectionTeacher[], Error, number>({
    ...
    courseSectionRepository.getAllCourseSectionBySection(sectionId).then((response) => response.body),
  });
}