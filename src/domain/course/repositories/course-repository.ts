...
class CourseRepository {
    ...
    create = (data: ICreateEditCourse): Promise<HttpResponse<IRegisterResponse>> => {
    ...
    edit = (courseId: number, data: ICreateEditCourse): Promise<HttpResponse<IRegisterResponse>> => {
